const translations = {
  nl: {
    ...
    metadata: {
      ...
      notes: "Notities",
      preset: "Preset",
      openPreset: "📂 Upload / Bekijk Preset",
    },
    presetDialog: {
      title: "Preset Details",
      savedPresets: "Opgeslagen",
      uploadText: "Sleep een JSON bestand hierheen of klik om te uploaden",
      selectFile: "Kies bestand",
      filename: "Bestandsnaam:",
      replace: "Vervang",
      delete: "🗑️",
      save: "💾 Opslaan",
      noPresets: "Geen presets gevonden",
      confirmOverwrite: "Bestand bestaat al. Overschrijven?",
      saved: "Preset opgeslagen",
      replaced: "Preset vervangen",
      confirmDelete: "Weet je zeker dat je deze preset wilt verwijderen?",
    ...
    alerts: {
      ...
      videosExported: "Video's succesvol geëxporteerd naar map: {{dir}}",
      videosExportedDetail: "De video's zijn opgeslagen in de map '{{dir}}' binnen de projectmap. Je kunt het pad kopiëren of de projectmap openen om de bestanden te bekijken.",
      projectDeleted: "Project succesvol verwijderd",
      presetSaved: "Preset '{{name}}' succesvol opgeslagen in de map 'presets'",
    },
    errors: {
      projectNameRequired: "Projectnaam is verplicht",
      createProject: "Project aanmaken mislukt",
      exportVideos: "Video's exporteren mislukt",
      ...
      invalidFileType: "Ongeldig bestandstype. Upload een .json bestand.",
      invalidJson: "Ongeldige JSON structuur.",
      presetSaveFailed: "Preset opslaan mislukt",
      ...
      presetNameRequired: "Naam is verplicht",
...
(at 5 seconds: final wide shot as he lowers the can, camera completes orbit to original angle, showcasing the kitchen space, lighting, and dynamic movement).</pre>
  ...
  en: {
    ...
    metadata: {
      ...
      notes: "Notes",
      preset: "Preset",
      openPreset: "📂 Upload / View Preset",
    },
    presetDialog: {
      title: "Preset Details",
      savedPresets: "Saved",
      uploadText: "Drag a JSON file here or click to upload",
  ...
  translationPlaceholder: "Write notes or the translated prompt...",
    ...
    alerts: {
      ...
      videosExported: "Videos exported to folder: {{dir}}",
      videosExportedDetail: "The videos have been written into the '{{dir}}' folder inside the project directory. You can copy the path or open the project folder to inspect the files.",
      projectDeleted: "Project successfully deleted",
      presetSaved: "Preset '{{name}}' successfully saved to 'presets' folder",
    },
    errors: {
      ...
      exportVideos: "Failed to export videos",
